         ...
         <header class="header-desktop">
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    ...
                    <div class="side-bar">
                        ...
                        <div class="menu">
                            <div class="item"><a href="<?php echo e(route('dashboard')); ?>"><i class="fas fa-desktop"></i>Dashboard</a></div>
                            <div class="item"><a class="sub-btn" href="#"><i class="fas fa-table"></i>Posts
                                    <i class="fas fa-angle-right dropdown"></i></a>
                                <div class="sub-menu">
                                    <a href="<?php echo e(route('post#createPage')); ?>" class="sub-item">Create Post</a>
                    ...
                    <div class="header-wrap">
                        ...
                        <form class="ml-5 form-header" action="" method="POST">
                                    ...
                                    <div class="account-dropdown js-dropdown">
                                      ...
                                      <form method="post" action="<?php echo e(route('logout')); ?>">
                                        ...
                                        <div class="account-dropdown__footer">
                                         <a><button type="submit" class="col-12"> <i class="zmdi zmdi-power"></i>Logout</button></a>
                                        </div>
                                    </form>
            ...
            <footer>
                <div class="row footer">
                  ...
                  <div class="col-xl-4 col-lg col-md-8">
                    <ul class="text-dark">
                      <li>About</li>
                      <li>subscribe</li>
                      <li>Contact</li>
...
<?php /**PATH C:\xampp\htdocs\book_shop_one\resources\views/home/dashboard.blade.php ENDPATH**/ ?>